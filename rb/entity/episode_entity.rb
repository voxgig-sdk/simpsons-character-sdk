# SimpsonsCharacter SDK Episode entity
...
class EpisodeEntity
  ...
  # @return [Episode, Hash] the loaded Episode; raises SimpsonsCharacterError on failure
  ...
  # @param ctrl [Object, nil] optional per-call control
  # @return [Array<Episode>, Array] the matching Episode items; raises SimpsonsCharacterError on failure

# SimpsonsCharacter Ruby SDK



The Ruby SDK for the SimpsonsCharacter API — an entity-oriented client using idiomatic Ruby conventions.
...
raise a `SimpsonsCharacterError` (a `StandardError` subclass), so wrap
...
```
rb/
├── SimpsonsCharacter_sdk.rb       -- Main SDK module
...
The main module (`SimpsonsCharacter_sdk`) exports the SDK class

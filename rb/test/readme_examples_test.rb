...
#      offline in seeded test mode (SimpsonsCharacterSDK.test) against the real
...
class ReadmeExamplesTest < Minitest::Test
  ...
  SDK = File.join(__dir__, "..", "SimpsonsCharacter_sdk.rb")
  SDK_CLASS = "SimpsonsCharacterSDK"
  ...
  SDK_BASE = "SimpsonsCharacter_sdk"

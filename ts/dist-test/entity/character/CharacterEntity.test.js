...
(0, node_test_1.describe)('CharacterEntity', async () => {
    ...
    (0, node_test_1.test)('instance', async () => {
        const testsdk = __1.SimpsonsCharacterSDK.test();
    ...
    (0, node_test_1.test)('basic', async (t) => {
        ...
        if (setup.syntheticOnly) {
            t.skip('live entity test uses synthetic IDs from fixture — set SIMPSONS_CHARACTER_TEST_CHARACTER_ENTID JSON to run live');
            return;
        }
...
function basicSetup(extra) {
    ...
    let client = __1.SimpsonsCharacterSDK.test(options, extra);
    ...
    const idmapEnvVal = process.env['SIMPSONS_CHARACTER_TEST_CHARACTER_ENTID'];
    ...
    if (live) {
        client = new __1.SimpsonsCharacterSDK(merge([

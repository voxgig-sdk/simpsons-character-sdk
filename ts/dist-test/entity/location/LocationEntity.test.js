...
(0, node_test_1.describe)('LocationEntity', async () => {
    ...
    (0, node_test_1.test)('basic', async (t) => {
        ...
        if (setup.syntheticOnly) {
            t.skip('live entity test uses synthetic IDs from fixture — set SIMPSONS_CHARACTER_TEST_LOCATION_ENTID JSON to run live');
            return;
        }
...
function basicSetup(extra) {
    ...
    const idmapEnvVal = process.env['SIMPSONS_CHARACTER_TEST_LOCATION_ENTID'];

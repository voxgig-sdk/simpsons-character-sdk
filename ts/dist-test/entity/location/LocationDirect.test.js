...
(0, node_test_1.describe)('LocationDirect', async () => {
    ...
    (0, node_test_1.afterEach)((0, utility_1.liveDelay)('SIMPSONS_CHARACTER_TEST_LIVE'));
    (0, node_test_1.test)('direct-exists', async () => {
        const sdk = new __1.SimpsonsCharacterSDK({
...
function liveScenariosActive() { return false && process.env.SIMPSONS_CHARACTER_TEST_LIVE === 'TRUE'; }
function directSetup(mockres) {
    ...
    if (live) {
        ...
        const client = new __1.SimpsonsCharacterSDK(Object.assign({}, (0, utility_1.liveClientOptions)(), { system: { fetch: transport.fetch },
        }));
        let idmap = env['SIMPSONS_CHARACTER_TEST_LOCATION_ENTID'];
    ...
    const client = new __1.SimpsonsCharacterSDK({
        base: 'http://localhost:8080',

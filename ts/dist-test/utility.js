...
function envOverride(m) {
    if ('TRUE' === process.env.SIMPSONS_CHARACTER_TEST_LIVE ||
        'TRUE' === process.env.SIMPSONS_CHARACTER_TEST_OVERRIDE) {
    ...
    m.SIMPSONS_CHARACTER_TEST_EXPLAIN = process.env.SIMPSONS_CHARACTER_TEST_EXPLAIN || m.SIMPSONS_CHARACTER_TEST_EXPLAIN;
    return m;
}

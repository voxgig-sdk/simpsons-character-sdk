# SimpsonsCharacter TypeScript SDK



The TypeScript SDK for the SimpsonsCharacter API — a type-safe, entity-oriented client with full async/await support.
...
- Releases: [https://github.com/voxgig-sdk/simpsons-character-sdk/releases](https://github.com/voxgig-sdk/simpsons-character-sdk/releases)
...
```ts
import { SimpsonsCharacterSDK } from '@voxgig-sdk/simpsons-character-sdk'
...
```ts
new SimpsonsCharacterSDK(options?: {
  base?: string
  prefix?: string
  suffix?: string
...
| `tester(testopts?, sdkopts?)` | `SimpsonsCharacterSDK` | Create a test-mode client instance. |

#### Static methods

| Method | Returns | Description |
| --- | --- | --- |
| `SimpsonsCharacterSDK.test(testopts?, sdkopts?)` | `SimpsonsCharacterSDK` | Create a test-mode client. |
...
| `client` | `client(): SimpsonsCharacterSDK` | Return the parent SDK client. |
...
simpsons-character/
├── src/
│   ├── SimpsonsCharacterSDK.ts        # Main SDK class

...
The TypeScript SDK for the SimpsonsCharacter API. Provides a type-safe, entity-oriented interface with full async/await support.
...
```ts
const client = new SimpsonsCharacterSDK({ apikey: '...' })

...
function runner.env_override(m)
  local live = runner.getenv("SIMPSONSCHARACTER_TEST_LIVE")
  local override = runner.getenv("SIMPSONSCHARACTER_TEST_OVERRIDE")
  ...
  local explain = runner.getenv("SIMPSONSCHARACTER_TEST_EXPLAIN")

...
function runner.env_override(m)
  local live = runner.getenv("SIMPSONS_CHARACTER_TEST_LIVE")
  local override = runner.getenv("SIMPSONS_CHARACTER_TEST_OVERRIDE")
  ...
  local explain = runner.getenv("SIMPSONS_CHARACTER_TEST_EXPLAIN")

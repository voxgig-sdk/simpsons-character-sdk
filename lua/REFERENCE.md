# SimpsonsCharacter Lua SDK Reference

Complete API reference for the SimpsonsCharacter Lua SDK.
...
| `phrases` | `table` | No | Famous quotes and catchphrases of the character |

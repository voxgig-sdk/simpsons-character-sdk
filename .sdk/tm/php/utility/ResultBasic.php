...
// SimpsonsCharacter SDK utility: result_basic

class SimpsonsCharacterResultBasic
{
    public static function call(SimpsonsCharacterContext $ctx): ?SimpsonsCharacterResult
    {
        ...
        if ($result && $response) {
            ...
            if ($result->status >= 400) {
                ...
                if ($result->err) {
                    $prev = ($result->err instanceof SimpsonsCharacterError) ? $result->err->msg : (string)$result->err;

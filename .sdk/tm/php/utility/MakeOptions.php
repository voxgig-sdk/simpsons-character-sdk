...
// SimpsonsCharacter SDK utility: make_options

class SimpsonsCharacterMakeOptions
{
    ...
    public static function call(SimpsonsCharacterContext $ctx): array
    {
        ...
        //
        // `SimpsonsCharacterSchema::optspec()` is built from the model:
        ...
        $optspec = SimpsonsCharacterSchema::optspec();

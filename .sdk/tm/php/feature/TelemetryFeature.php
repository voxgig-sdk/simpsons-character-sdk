...
// SimpsonsCharacter SDK telemetry feature
...
class SimpsonsCharacterTelemetryFeature extends SimpsonsCharacterBaseFeature
{
    ...
    private function _close(SimpsonsCharacterContext $ctx, bool $ok): void
    {

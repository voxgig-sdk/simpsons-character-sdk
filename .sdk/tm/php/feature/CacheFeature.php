...
// SimpsonsCharacter SDK cache feature
...
class SimpsonsCharacterCacheFeature extends SimpsonsCharacterBaseFeature
{
    ...
    private function _through(SimpsonsCharacterContext $ctx, string $url, array $fetchdef, callable $inner): array
    {

...
// SimpsonsCharacter SDK streaming feature
...
class SimpsonsCharacterStreamingFeature extends SimpsonsCharacterBaseFeature
{
    ...
    private function _iterate(SimpsonsCharacterResult $result): \Generator
    {
    ...
    private function _streamable(SimpsonsCharacterContext $ctx): bool
    {

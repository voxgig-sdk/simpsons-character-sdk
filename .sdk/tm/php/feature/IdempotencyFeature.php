...
// SimpsonsCharacter SDK idempotency feature
...
class SimpsonsCharacterIdempotencyFeature extends SimpsonsCharacterBaseFeature
{
    ...
    private function _mutating(SimpsonsCharacterContext $ctx): bool
    {

...
// SimpsonsCharacter SDK netsim feature
...
class SimpsonsCharacterNetsimFeature extends SimpsonsCharacterBaseFeature
{
    ...
    private function _simulate(SimpsonsCharacterContext $ctx, string $url, array $fetchdef, callable $inner): array
    {
        $opts = $this->options ?? [];
        $this->calls++;
        $call = $this->calls;
    ...
    private function _track(SimpsonsCharacterContext $ctx, array $applied): void
    {
        $client = $this->client;

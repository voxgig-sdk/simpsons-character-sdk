...
// SimpsonsCharacter SDK rbac feature
...
class SimpsonsCharacterRbacFeature extends SimpsonsCharacterBaseFeature
{
    ...
    private function _required(SimpsonsCharacterContext $ctx): ?string
    {
    ...
    private function _reject(SimpsonsCharacterContext $ctx, string $required): void
    {
    ...
    private function _track(SimpsonsCharacterContext $ctx, string $required, bool $allowed): void
    {
        $client = $this->client;

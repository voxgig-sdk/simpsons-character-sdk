...
// SimpsonsCharacter SDK audit feature
...
class SimpsonsCharacterAuditFeature extends SimpsonsCharacterBaseFeature
{
    ...
    private function _emit(SimpsonsCharacterContext $ctx, string $outcome): void
    {

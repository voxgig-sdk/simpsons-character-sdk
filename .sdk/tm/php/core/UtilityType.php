...
// SimpsonsCharacter SDK utility type

class SimpsonsCharacterUtility
{
    ...
    public static function copy(SimpsonsCharacterUtility $src): SimpsonsCharacterUtility
    {
        $u = new SimpsonsCharacterUtility();
        $u->clean = $src->clean;
        $u->done = $src->done;

...
class SimpsonsCharacterTestRunner:
    ...
    @staticmethod
    def env_override(m):
        live = SimpsonsCharacterTestRunner.getenv("PROJECTENV_TEST_LIVE")
        override = SimpsonsCharacterTestRunner.getenv("PROJECTENV_TEST_OVERRIDE")
        ...
        explain = SimpsonsCharacterTestRunner.getenv("PROJECTENV_TEST_EXPLAIN")

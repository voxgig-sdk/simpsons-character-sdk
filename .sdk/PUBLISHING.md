...
|---|---|---|
| `ts/` | @voxgig-sdk/simpsons-character-sdk | `.github/workflows/publish-ts.yml` |
...
required):
    ...
    npm trust github @voxgig-sdk/simpsons-character-sdk \
      --repository voxgig-sdk/simpsons-character-sdk \
      --file publish-ts.yml \
      --allow-publish

Then `npm trust list @voxgig-sdk/simpsons-character-sdk` shows it, and
`npm trust revoke @voxgig-sdk/simpsons-character-sdk --id=<id>` removes it.

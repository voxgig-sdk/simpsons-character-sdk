// Command SimpsonsCharacter-mcp is an MCP server exposing the SimpsonsCharacter
// SDK as MCP tools.
//
// Two tools are registered:
//
//	SimpsonsCharacter_list  — list records of an entity
//	SimpsonsCharacter_load  — load a single record of an entity
//

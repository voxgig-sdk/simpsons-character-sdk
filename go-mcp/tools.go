...
type Args struct {
	Entity string         `json:"entity" jsonschema:"character | episode | location"`
	Query  map[string]any `json:"query,omitempty" jsonschema:"optional match map e.g. {\"id\":1} for load, omit for list"`
}

func registerTools(server *mcp.Server, client *sdk.SimpsonsCharacterSDK) {
	mcp.AddTool(server, &mcp.Tool{
		Name: "simpsons-character_list",
		Description: "List records from SimpsonsCharacter. " +
	...
	mcp.AddTool(server, &mcp.Tool{
		Name: "simpsons-character_load",
		Description: "Load a single record from SimpsonsCharacter. " +
...
func runOp(client *sdk.SimpsonsCharacterSDK, op string, args Args) (*mcp.CallToolResult, any, error) {
...
func entityFor(client *sdk.SimpsonsCharacterSDK, name string) (sdk.SimpsonsCharacterEntity, error) {

...
The Golang SDK for the SimpsonsCharacter API. Provides an entity-oriented interface using standard Go conventions — no generics required, data flows as `map[string]any`.


## Install
```bash
go get github.com/voxgig-sdk/simpsons-character-sdk
```
...
```bash
go mod edit -replace github.com/voxgig-sdk/simpsons-character-sdk=../path/to/github.com/voxgig-sdk/simpsons-character-sdk
```
...
```
github.com/voxgig-sdk/simpsons-character-sdk/
...
The root package (`github.com/voxgig-sdk/simpsons-character-sdk`) re-exports everything needed

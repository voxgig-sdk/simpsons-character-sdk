...
type SimpsonsCharacterSDK struct {
	Mode     string
...
func (sdk *SimpsonsCharacterSDK) OptionsMap() map[string]any {
...
func (sdk *SimpsonsCharacterSDK) GetUtility() *Utility {
	return CopyUtility(sdk.utility)
}

func (sdk *SimpsonsCharacterSDK) GetRootCtx() *Context {
	return sdk.rootctx
}

func (sdk *SimpsonsCharacterSDK) Prepare(fetchargs map[string]any) (map[string]any, error) {
	utility := sdk.utility
...
func (sdk *SimpsonsCharacterSDK) Direct(fetchargs map[string]any) (map[string]any, error) {
...
func (sdk *SimpsonsCharacterSDK) opAllowed(op string) bool {
	allowOp, _ := vs.GetPath([]any{"allow", "op"}, sdk.options).(string)
	return strings.Contains(allowOp, op)
}

func (sdk *SimpsonsCharacterSDK) opDenied(op string) map[string]any {
	allowOp, _ := vs.GetPath([]any{"allow", "op"}, sdk.options).(string)
	return map[string]any{
		"ok": false,
		"err": fmt.Errorf("SimpsonsCharacterSDK: %s: operation not allowed by"+
...
// gate by passing it.
func (sdk *SimpsonsCharacterSDK) rawRequest(fetchargs map[string]any) (map[string]any, error) {
	utility := sdk.utility
...
func (sdk *SimpsonsCharacterSDK) Graphql(
	...
	if 0 < len(errors) {
		...
		res["ok"] = false
		res["err"] = fmt.Errorf("SimpsonsCharacterSDK: graphql: %s", msg)
		res["graphql"] = errors
	}
...
func TestSDK(testopts map[string]any, sdkopts map[string]any) *SimpsonsCharacterSDK {
	...
	sdk := NewSimpsonsCharacterSDK(sdkopts)
	sdk.Mode = "test"

...
// instead of `sdk.NewSimpsonsCharacterSDK(nil)` / `sdk.TestSDK(nil, nil)`
// for the common no-options case.
func New() *SimpsonsCharacterSDK  { return NewSimpsonsCharacterSDK(nil) }
func Test() *SimpsonsCharacterSDK { return TestSDK(nil, nil) }

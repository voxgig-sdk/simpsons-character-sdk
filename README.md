...
This is an unofficial SDK for the Simpsons Character public API, generated by Voxgig with [`@voxgig/sdkgen`](https://github.com/voxgig/sdkgen). It is not affiliated with, endorsed by, or sponsored by the upstream API provider.
...
| --- | --- | --- |
| TypeScript | `@voxgig-sdk/simpsons-character` | `npm install @voxgig-sdk/simpsons-character` |
| Python | `voxgig-sdk-simpsons-character` | `pip install voxgig-sdk-simpsons-character` |
| PHP | `voxgig-sdk/simpsons-character` | `composer require voxgig-sdk/simpsons-character` |
| Golang | `github.com/voxgig-sdk/simpsons-character-sdk/go` | `go get github.com/voxgig-sdk/simpsons-character-sdk/go` |
| Ruby | `voxgig-sdk-simpsons-character` | `gem install voxgig-sdk-simpsons-character` |
| Lua | `voxgig-sdk-simpsons-character` | `luarocks install voxgig-sdk-simpsons-character` |
...
- Upstream API: [https://thesimpsonsapi.com/](https://thesimpsonsapi.com/)

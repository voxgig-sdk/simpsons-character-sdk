# SimpsonsCharacter SDK — documentation python-examples COMPLETENESS gate.
#
...
#      SDK (mentions SimpsonsCharacterSDK) OR drives a client/sdk variable the narrative
#      built earlier ("client." / "sdk."). A constructing block is rewritten so
#      both SimpsonsCharacterSDK(...) and SimpsonsCharacterSDK.test(...) become
#      SimpsonsCharacterSDK.test({"entity": {...}}) seeding one mock record (id "test01")
...
_SDK_MODULE = "simpsonscharacter_sdk"
_SDK_CLASS = "SimpsonsCharacterSDK"

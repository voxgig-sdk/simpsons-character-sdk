...
from simpsonscharacter_sdk.core.helpers import get_ctx_prop, to_map
...
class SimpsonsCharacterContext:
    def __init__(self, ctxmap=None, basectx=None):
        ...
        # Ctrl
        self.ctrl = SimpsonsCharacterControl()
        ...
        if isinstance(sp, SimpsonsCharacterSpec):
            self.spec = sp
        elif basectx is not None:
        ...
        if isinstance(r, SimpsonsCharacterResult):
            self.result = r
        elif basectx is not None:
        ...
        if isinstance(rp, SimpsonsCharacterResponse):
            self.response = rp
        elif basectx is not None:
    ...
    def resolve_op(self, opname):
        ...
        if opname == "":
            return SimpsonsCharacterOperation({})
    ...
    def make_error(self, code, msg):
        return SimpsonsCharacterError(code, msg, self)

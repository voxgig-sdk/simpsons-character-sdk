...
from simpsonscharacter_sdk.utility import register

# Load features
from simpsonscharacter_sdk.feature.base_feature import SimpsonsCharacterBaseFeature
from simpsonscharacter_sdk.features import _has_feature, _make_feature
...
class SimpsonsCharacterSDK:
    ...
    def get_utility(self):
        return SimpsonsCharacterUtility.copy(self._utility)
    ...
    def graphql(self, query, variables=None, ctrl=None):
        ...
        if isinstance(errors, list) and 0 < len(errors):
            ...
            res["ok"] = False
            res["err"] = Exception("SimpsonsCharacterSDK: graphql: " + str(msg))
            res["graphql"] = errors
    ...
    def Character(self, data=None) -> "CharacterEntity":
        ...
        from simpsonscharacter_sdk.entity.character_entity import CharacterEntity
    ...
    def Episode(self, data=None) -> "EpisodeEntity":
        ...
        from simpsonscharacter_sdk.entity.episode_entity import EpisodeEntity
    ...
    def Location(self, data=None) -> "LocationEntity":
        ...
        from simpsonscharacter_sdk.entity.location_entity import LocationEntity

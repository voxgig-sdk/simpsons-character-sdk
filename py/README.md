...
The Python SDK for the SimpsonsCharacter API — an entity-oriented client following Pythonic conventions.
...
release tag (`py/vX.Y.Z`, see [Releases](https://github.com/voxgig-sdk/simpsons-character-sdk/releases)) or

...
AQL-driven CLI and REPL for the SimpsonsCharacter SDK. Positional arguments are
...
```sh
go build -o simpsons-character-cli ./...
```
...
./simpsons-character-cli load 1 character
./simpsons-character-cli load '{id:1}' character

...
func registerSDKWords(r *eng.Registry, client *sdk.SimpsonsCharacterSDK) {
...
func runOp(client *sdk.SimpsonsCharacterSDK, op string, query *eng.Value, entityAtom eng.Value) ([]eng.Value, error) {

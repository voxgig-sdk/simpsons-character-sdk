...
// SimpsonsCharacter SDK pipeline test
//
...
{
    private static function utility(): SimpsonsCharacterUtility
    {
        return new SimpsonsCharacterUtility();
    }
    ...
    private static function ctx(array $over = []): SimpsonsCharacterContext
    {
        $utility = $over['utility'] ?? self::utility();
        $client = $over['client'] ?? new PlClient(['base' => 'http://h']);
        $ctx = new SimpsonsCharacterContext([
            'client' => $client,
            'utility' => $utility,
        ], null);
        $ctx->op = new SimpsonsCharacterOperation(['name' => 'load', 'entity' => 'x']);
        foreach ($over as $k => $v) {
    ...
    {
        return ($err instanceof SimpsonsCharacterError) ? $err->sdk_code : '';
    }
    ...
    public function test_make_point_rejects_a_disallowed_operation(): void
    {
        ...
        $ctx->op = new SimpsonsCharacterOperation(['name' => 'nope', 'entity' => 'x']);
        [$point, $err] = SimpsonsCharacterMakePoint::call($ctx);
    ...
    public function test_make_point_rejects_an_operation_with_no_endpoints(): void
    {
        ...
        $ctx->op = new SimpsonsCharacterOperation(['name' => 'load', 'entity' => 'x', 'points' => []]);
        [$point, $err] = SimpsonsCharacterMakePoint::call($ctx);
        $this->assertNull($point);
    ...
    public function test_make_point_returns_the_single_point(): void
    {
        ...
        $ctx = self::ctx(['options' => ['allow' => ['op' => 'load,list,create,update,remove']]]);
        $ctx->op = new SimpsonsCharacterOperation(['name' => 'load', 'entity' => 'x', 'points' => [$point]]);
        [$got, $err] = SimpsonsCharacterMakePoint::call($ctx);
        $this->assertNull($err);
    ...
    {
        $preset = new SimpsonsCharacterSpec(['method' => 'GET']);
        $ctx = self::ctx();
        $ctx->out['spec'] = $preset;
        [$got, $err] = SimpsonsCharacterMakeSpec::call($ctx);
        $this->assertNull($err);
        $this->assertSame($preset, $got);
    }
    ...
    public function test_make_response_guards_missing_spec_response_result(): void
    {
        $ctx = self::ctx([
            'spec' => null,
            'response' => new SimpsonsCharacterResponse([]),
            'result' => new SimpsonsCharacterResult([]),
        ]);
        [, $err] = SimpsonsCharacterMakeResponse::call($ctx);
        $this->assertSame('response_no_spec', self::code($err));

        $ctx = self::ctx([
            'spec' => new SimpsonsCharacterSpec([]),
            'response' => null,
            'result' => new SimpsonsCharacterResult([]),
        ]);
        [, $err] = SimpsonsCharacterMakeResponse::call($ctx);
    ...
    {
        $ctx = self::ctx([
            'spec' => new SimpsonsCharacterSpec(['step' => 's']),
            'response' => new SimpsonsCharacterResponse(self::resp(404, null, ['x-a' => '1'])),
            'result' => new SimpsonsCharacterResult([]),
        ]);
        [, $err] = SimpsonsCharacterMakeResponse::call($ctx);
        $this->assertNull($err);
    ...
    public function test_make_response_2xx_parses_the_body_and_marks_ok(): void
    {
        $ctx = self::ctx([
            'spec' => new SimpsonsCharacterSpec(['step' => 's']),
            'response' => new SimpsonsCharacterResponse(self::resp(200, ['v' => 1])),
            'result' => new SimpsonsCharacterResult([]),
        ]);
        [, $err] = SimpsonsCharacterMakeResponse::call($ctx);
        $this->assertNull($err);
    ...
    public function test_make_response_records_to_ctrl_explain_when_explain_is_on(): void
    {
        $ctx = self::ctx([
            'spec' => new SimpsonsCharacterSpec(['step' => 's']),
            'response' => new SimpsonsCharacterResponse(self::resp(200, ['v' => 2])),
            'result' => new SimpsonsCharacterResult([]),
        ]);
        $ctx->ctrl->explain = ['on' => true];
        SimpsonsCharacterMakeResponse::call($ctx);
    ...
    {
        $preset = new SimpsonsCharacterResponse(self::resp(299));
        $ctx = self::ctx([
            'spec' => new SimpsonsCharacterSpec([]),
            'response' => new SimpsonsCharacterResponse([]),
            'result' => new SimpsonsCharacterResult([]),
        ...
        [$got, $err] = SimpsonsCharacterMakeResponse::call($ctx);
        $this->assertNull($err);
        $this->assertSame($preset, $got);
    }
    ...
    {
        $ctx = self::ctx(['spec' => null, 'result' => new SimpsonsCharacterResult([])]);
        [, $err] = SimpsonsCharacterMakeResult::call($ctx);
        $this->assertSame('result_no_spec', self::code($err));

        $ctx = self::ctx(['spec' => new SimpsonsCharacterSpec([]), 'result' => null]);
        [, $err] = SimpsonsCharacterMakeResult::call($ctx);
    ...
    public function test_make_result_list_op_wraps_resdata_into_entity_instances(): void
    {
        ...
        $ctx = self::ctx([
            'entity' => $entity,
            'spec' => new SimpsonsCharacterSpec(['step' => 's']),
            'result' => new SimpsonsCharacterResult(['ok' => true, 'resdata' => [['a' => 1], ['a' => 2]]]),
        ]);
        $ctx->op = new SimpsonsCharacterOperation(['name' => 'list', 'entity' => 'x']);
        [$result, $err] = SimpsonsCharacterMakeResult::call($ctx);
        $this->assertNull($err);
    ...
    public function test_make_result_empty_list_yields_empty_resdata(): void
    {
        ...
        $ctx = self::ctx([
            'entity' => $entity,
            'spec' => new SimpsonsCharacterSpec(['step' => 's']),
            'result' => new SimpsonsCharacterResult(['ok' => true, 'resdata' => []]),
        ]);
        $ctx->op = new SimpsonsCharacterOperation(['name' => 'list', 'entity' => 'x']);
        [$result, $err] = SimpsonsCharacterMakeResult::call($ctx);
        $this->assertNull($err);
    ...
    {
        $preset = new SimpsonsCharacterResult(['ok' => true]);
        $ctx = self::ctx([
            'spec' => new SimpsonsCharacterSpec([]),
            'result' => new SimpsonsCharacterResult([]),
        ]);
        $ctx->out['result'] = $preset;
        [$got, $err] = SimpsonsCharacterMakeResult::call($ctx);
        $this->assertNull($err);
        $this->assertSame($preset, $got);
    }
    ...
    public function test_make_request_guards_a_missing_spec(): void
    {
        ...
        [, $err] = SimpsonsCharacterMakeRequest::call($ctx);
    ...
    {
        $utility = self::utility();
        $boom = new SimpsonsCharacterError('boom', 'boom');
        $utility->fetcher = function (SimpsonsCharacterContext $_c, string $_u, array $_f) use ($boom): array {
            return [null, $boom];
        };
        $ctx = self::ctx([
            'utility' => $utility,
            'spec' => new SimpsonsCharacterSpec(['step' => 's', 'method' => 'GET', 'base' => 'http://h', 'parts' => ['a']]),
        ]);
        [$response, $err] = SimpsonsCharacterMakeRequest::call($ctx);
        $this->assertNull($err);
    ...
    {
        $utility = self::utility();
        $utility->fetcher = function (SimpsonsCharacterContext $_c, string $_u, array $_f): array {
            return [null, null];
        };
        $ctx = self::ctx([
            'utility' => $utility,
    ...
    public function test_make_request_a_normal_transport_response_is_wrapped(): void
    {
        ...
        [$response, $err] = SimpsonsCharacterMakeRequest::call($ctx);
        $this->assertNull($err);
        $this->assertInstanceOf(SimpsonsCharacterResponse::class, $response);
    ...
    public function test_make_request_records_the_fetchdef_to_ctrl_explain(): void
    {
        ...
        $ctx->ctrl->explain = ['on' => true];
        SimpsonsCharacterMakeRequest::call($ctx);
    ...
    {
        $utility = self::utility();
        $utility->make_fetch_def = function (SimpsonsCharacterContext $c): array {
            return [null, $c->make_error('fetchdef_boom', 'boom')];
        };
        $ctx = self::ctx([
            'utility' => $utility,
            'spec' => new SimpsonsCharacterSpec(['step' => 's', 'method' => 'GET']),
        ]);
        [$response, $err] = SimpsonsCharacterMakeRequest::call($ctx);
        $this->assertNull($err);
        $this->assertNotNull($response->err);
    ...
    {
        $preset = new SimpsonsCharacterResponse(self::resp(201));
        $ctx = self::ctx(['spec' => new SimpsonsCharacterSpec([])]);
        $ctx->out['request'] = $preset;
        [$got, $err] = SimpsonsCharacterMakeRequest::call($ctx);
        $this->assertNull($err);
        $this->assertSame($preset, $got);
    }
    ...
    {
        $ctx = self::ctx(['spec' => null]);
        [, $err] = SimpsonsCharacterMakeFetchDef::call($ctx);
    ...
    public function test_make_fetch_def_serialises_body_and_inits_missing_result(): void
    {
        ...
        [$fetchdef, $err] = SimpsonsCharacterMakeFetchDef::call($ctx);
        $this->assertNull($err);
    ...
    {
        $ctx = self::ctx(['result' => new SimpsonsCharacterResult(['ok' => true, 'resdata' => 42])]);
        $this->assertSame(42, SimpsonsCharacterDone::call($ctx));
    }

    public function test_done_raises_the_error_when_not_ok(): void
    {
        $ctx = self::ctx(['result' => new SimpsonsCharacterResult(['ok' => false])]);
        $this->expectException(SimpsonsCharacterError::class);
        SimpsonsCharacterDone::call($ctx);
    }

    public function test_make_error_returns_resdata_when_ctrl_throw_is_false(): void
    {
        $ctx = self::ctx(['result' => new SimpsonsCharacterResult(['ok' => false, 'resdata' => 'fallback'])]);
        $ctx->ctrl->throw_err = false;
        $this->assertSame('fallback', SimpsonsCharacterMakeError::call($ctx, null));
    }
    ...
    public function test_make_error_records_to_ctrl_explain(): void
    {
        ...
        $ctx->ctrl->throw_err = false;
        $ctx->ctrl->explain = ['on' => true];
        SimpsonsCharacterMakeError::call($ctx, null);
    ...
    public function test_feature_add_appends_in_call_order(): void
    {
        ...
        $a = new SimpsonsCharacterBaseFeature();
        $b = new SimpsonsCharacterBaseFeature();
        SimpsonsCharacterFeatureAdd::call($ctx, $a);
        SimpsonsCharacterFeatureAdd::call($ctx, $b);
        $this->assertSame([$a, $b], $client->features);
    }

    private static function named_feature(string $name): SimpsonsCharacterBaseFeature
    {
        $f = new SimpsonsCharacterBaseFeature();
        $f->name = $name;
        return $f;
    }
    ...
    public function test_feature_add_ordering_before_after_replace(): void
    {
        ...
        SimpsonsCharacterFeatureAdd::call($ctx, self::named_feature('a'));
        SimpsonsCharacterFeatureAdd::call($ctx, self::named_feature('b'));
        $this->assertSame(['a', 'b'], $names());

        $before = self::named_feature('z1');
        $before->_options = ['__before__' => 'b'];
        SimpsonsCharacterFeatureAdd::call($ctx, $before);
        $this->assertSame(['a', 'z1', 'b'], $names());

        $after = self::named_feature('z2');
        $after->_options = ['__after__' => 'a'];
        SimpsonsCharacterFeatureAdd::call($ctx, $after);
        $this->assertSame(['a', 'z2', 'z1', 'b'], $names());

        $replace = self::named_feature('z3');
        $replace->_options = ['__replace__' => 'z1'];
        SimpsonsCharacterFeatureAdd::call($ctx, $replace);
        ...
        SimpsonsCharacterFeatureAdd::call($ctx, $miss);
    ...
    private static function auth_ctx(array $options, ?array $headers): SimpsonsCharacterContext
    {
        $client = new PlClient($options);
        return self::ctx([
            'client' => $client,
            'spec' => $headers === null ? null : new SimpsonsCharacterSpec(['headers' => $headers]),
        ]);
    }
    ...
    public function test_prepare_auth_guards_a_missing_spec(): void
    {
        ...
        [, $err] = SimpsonsCharacterPrepareAuth::call($ctx);
    ...
    public function test_prepare_auth_a_raw_apikey_goes_in_as_is(): void
    {
        ...
        SimpsonsCharacterPrepareAuth::call($ctx);
    ...
    {
        $ctx = self::ctx([
            'response' => new SimpsonsCharacterResponse(['headers' => null]),
            'result' => new SimpsonsCharacterResult([]),
        ]);
        SimpsonsCharacterResultHeaders::call($ctx);
    ...
    public function test_result_body_skips_parsing_when_the_body_is_absent(): void
    {
        ...
        SimpsonsCharacterResultBody::call($ctx);

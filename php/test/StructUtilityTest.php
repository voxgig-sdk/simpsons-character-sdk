...
// SimpsonsCharacter SDK struct utility test
//
...
class StructUtilityTest extends TestCase
{
    ...
    {
        if (self::$run === null) {
            $runner = SimpsonsCharacterOmni::makeStructRunner(
    ...
    {
        return SimpsonsCharacterOmni::objmodel(SimpsonsCharacterOmni::argval($val));
    }

    /** A single-case fixture value on the comparison side. */
    private static function outval($val)
    {
        return SimpsonsCharacterOmni::unmark($val);
    }

    /** A result normalised to the comparison model. */
    private static function resval($val)
    {
        return SimpsonsCharacterOmni::structfix($val, Struct::undef());
    }
        ...
        $this->runsection(
            ...
            function ($input) {
                ...
                if (is_object($store) && $haspath && Struct::undef() !== $val) {
                    ...
                    if (json_encode(SimpsonsCharacterOmni::structfix($now, Struct::undef()))
                        !== json_encode(SimpsonsCharacterOmni::structfix($val, Struct::undef()))) {

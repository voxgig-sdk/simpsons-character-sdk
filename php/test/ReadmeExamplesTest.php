...
// SimpsonsCharacter SDK — documentation example COMPLETENESS GATE.
//
...
//      EXECUTED offline in seeded test mode (SimpsonsCharacterSDK::test)
...
{
    private const SDK_CLASS = 'SimpsonsCharacterSDK';
    ...
    private const SDK_BASE = 'simpsonscharacter_sdk';
    ...
    public function test_php_examples_run_offline(): void
    {
        $ran = 0;
        $failures = [];
        $sdk = __DIR__ . '/../simpsonscharacter_sdk.php';
        foreach ($this->phpBlocks() as $blk) {

...
// SimpsonsCharacter SDK proxy feature
...
class SimpsonsCharacterProxyFeature extends SimpsonsCharacterBaseFeature
{
    ...
    public function init(SimpsonsCharacterContext $ctx, array $options): void
    {
        ...
        $utility->fetcher = function (SimpsonsCharacterContext $ctx2, string $url2, array $fetchdef) use ($inner): array {

...
// SimpsonsCharacter SDK debug feature
...
class SimpsonsCharacterDebugFeature extends SimpsonsCharacterBaseFeature
{
    ...
    private function _finish(SimpsonsCharacterContext $ctx, bool $ok): void
    {

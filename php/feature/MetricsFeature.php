...
// SimpsonsCharacter SDK metrics feature
...
class SimpsonsCharacterMetricsFeature extends SimpsonsCharacterBaseFeature
{
    ...
    private function _record(SimpsonsCharacterContext $ctx, bool $ok): void
    {

...
// SimpsonsCharacter SDK ratelimit feature
...
class SimpsonsCharacterRatelimitFeature extends SimpsonsCharacterBaseFeature
{
    ...
    private function _acquire(SimpsonsCharacterContext $ctx): void
    {
    ...
    private function _track(SimpsonsCharacterContext $_ctx, float $wait_ms): void
    {
        $client = $this->client;

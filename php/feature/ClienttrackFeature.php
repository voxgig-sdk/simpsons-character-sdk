...
// SimpsonsCharacter SDK clienttrack feature
...
class SimpsonsCharacterClienttrackFeature extends SimpsonsCharacterBaseFeature
{
    ...
    public function PostConstruct(SimpsonsCharacterContext $_ctx): void
    {
        if (!$this->active) {
            return;
        }
    ...
    private function _name(): string
    {
        ...
        $name = (is_string($name) && $name !== '') ? $name : 'SimpsonsCharacter-SDK';

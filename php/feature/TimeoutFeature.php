...
// SimpsonsCharacter SDK timeout feature
...
class SimpsonsCharacterTimeoutFeature extends SimpsonsCharacterBaseFeature
{
    ...
    private function _with_timeout(SimpsonsCharacterContext $ctx, string $url, array $fetchdef, callable $inner): array
    {
    ...
    private function _track(SimpsonsCharacterContext $_ctx, float $ms): void
    {
        $client = $this->client;

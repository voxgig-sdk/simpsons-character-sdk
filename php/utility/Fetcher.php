...
// SimpsonsCharacter SDK utility: fetcher

class SimpsonsCharacterFetcher
{
    ...
    public const DEFAULT_USER_AGENT = 'Mozilla/5.0 (compatible; SimpsonsCharacterSDK/1.0)';
    ...
    public static function call(SimpsonsCharacterContext $ctx, string $fullurl, array $fetchdef): array
    {

...
// SimpsonsCharacter SDK utility: graphql
//
...
class SimpsonsCharacterGraphql
{
    ...
    // equivalent.
    public static function body(SimpsonsCharacterContext $ctx): mixed
    {
    ...
    public static function errors(SimpsonsCharacterContext $ctx): bool
    {
        $result = $ctx->result;
        $point = $ctx->point;

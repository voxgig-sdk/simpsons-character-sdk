...
// SimpsonsCharacter SDK utility: transform_response

require_once __DIR__ . '/../core/Helpers.php';

class SimpsonsCharacterTransformResponse
{
    public static function call(SimpsonsCharacterContext $ctx): mixed
    {
        ...
        $transform = SimpsonsCharacterHelpers::to_map(\Voxgig\Struct\Struct::getprop($point, 'transform'));
        if (!$transform) {
            return null;
        }
